...
plot(avF, ratio, type="p", col = coll, xlim=c(ffrom,fto), log="y",ylim=c(0.1,5),
ylab="Backstep/Detachment ratio",pch=19,cex.axis=1.5,cex.lab=1.5,cex=1.2,
xlab="Force,pN")
...
setwd("C:/Users/algis/Desktop/Algis/Algis_UoW/analysis/compare/ratios")
