...
#maxx <- 125.6048
#filename <- "6.txt"
#directory <- "C:/Users/algis/Desktop/Algis/Algis_UoW_data/180328/"
#stepfind <- 1
...
thr <- 30
minstep <- 5 #nm
minF <- 1 #pN, later recalc as mindisp in nm #used to be 3, but for ADP and high ionic strength data reduce to 1
stepdif <- 5 # nm
